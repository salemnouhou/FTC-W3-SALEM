...
const HeroSection = () => {
  ...
  return (
    <div className="rounded-b-3xl relative md:max-h-[85vh] xl:max-h-[83vh] 2xl:max-h-[78vh] 4k:max-h-[69vh] overflow-hidden bg-gradient-to-br from-[#FCEED5] via-[#FCEED5] to-[#FFE7BA]">
      {/* Hero Background */}
      ...
      {/* Hero Content */}
      <div className="relative     max-w-[1444px]  mx-auto px-4  md:px-10   grid grid-rows-2 md:grid-cols-2 z-10   pt-10  xl:px-0">
